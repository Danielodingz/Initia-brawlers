...
// ── XP Top-Up Packages ──────────────────────────────────────────────────────
const TREASURY_ADDRESS = 'init1g329dvgxpqf6c6umly9q8g6643v3ecf3c8nqty'
...
const XP_PACKAGES: XpPackage[] = [
  { id: 'starter',  label: 'Starter Pack',  initAmount: 0.1,  uinitAmount: '100000',  xpGranted: 150,  badge: '🔰' },
  { id: 'warrior',  label: 'Warrior Pack',  initAmount: 0.25, uinitAmount: '250000',  xpGranted: 400,  badge: '⚔️', popular: true },
  { id: 'champion', label: 'Champion Pack', initAmount: 0.5,  uinitAmount: '500000',  xpGranted: 900,  badge: '🏆' },
  { id: 'legend',   label: 'Legend Pack',   initAmount: 1.0,  uinitAmount: '1000000', xpGranted: 2000, badge: '👑' },
]
    ...
    try {
      const msg = {
        ...
        value: {
          ...
          amount: [{ denom: 'uinit', amount: pkg.uinitAmount }],
        },
      }
    ...
    <div className="min-h-screen bg-[#07070f] text-white flex flex-col relative overflow-hidden">
        ...
        <main className="flex-1 relative z-10 p-6 lg:p-10">
          <div className="max-w-3xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-[10px] text-white/30 font-black uppercase tracking-widest mt-1 ml-5">
                Pay with INIT on testnet — XP credited instantly to your account
              </p>
            </div>
            ...
            {!isConnected ? (
              <div className="mb-8 flex items-center gap-4 p-5 border-2 border-orange-500/30 bg-orange-500/5">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-white/30 font-black uppercase tracking-widest mt-0.5">
                    Connect your Initia wallet to purchase XP with INIT
                  </div>
                </div>
              </div>
            ) : (
              <div className="mb-8 flex items-center gap-3 p-3 border-2 border-green-500/20 bg-green-500/5">
                ...
                <div className="text-[9px] font-black uppercase tracking-widest text-green-400/80">
                  Connected · Initia Testnet · Payment sent to treasury on confirmation
                </div>
              </div>
            )}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-[9px] font-black uppercase tracking-widest text-white/30 mt-0.5">Initia Testnet · INIT</div>
                      </div>
                    </div>
            ...
            <div className="mt-8 border-2 border-dashed border-white/8 p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { step: '01', text: 'Choose a package and click "Pay INIT"' },
                  { step: '02', text: 'Approve the transaction in your Initia wallet popup' },
              ...
              <div className="text-[9px] text-white/15 font-black uppercase tracking-widest mt-4">
                ▶ Testnet INIT only · No real money · Get faucet at faucet.testnet.initia.xyz
              </div>
            </div>
          </div>
        </main>
      ...
      <div className="relative z-20 bg-[#0a0a14] border-t-2 border-[#1a1a2e] px-6 py-3 flex items-center justify-between">
        <div className="text-[9px] font-black uppercase tracking-widest text-white/20">
          Earn XP by defeating bots · Buy more with INIT
        </div>
        <div className="flex items-center gap-2">
