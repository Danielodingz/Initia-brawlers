...
var ICONS = {
  add: async () => (await import("./add-2EHFVGQO.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-BTPSTADZ.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-DXJ2KMAK.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-RR3CLHAT.js")).appStoreSvg,
  apple: async () => (await import("./apple-6O3IL7GJ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-5NZYPBFB.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-4HE3B6TL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-5FQEFIDL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-CR4SVEAS.js")).arrowTopSvg,
  bank: async () => (await import("./bank-2NMZRNKX.js")).bankSvg,
  browser: async () => (await import("./browser-5VM6D2UA.js")).browserSvg,
  card: async () => (await import("./card-ZTJYJUV7.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-XE5PTNXG.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-MZAW6J27.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-MEFA76GX.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-EZDRMWMZ.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-FKUMSCF5.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-2JV3PDP5.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-CSOLOWSN.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-IDRIQO3K.js")).clockSvg,
  close: async () => (await import("./close-RS5HYR5S.js")).closeSvg,
  compass: async () => (await import("./compass-3RNLVPZ3.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ZVHJOXOU.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-X2VU4GYR.js")).copySvg,
  cursor: async () => (await import("./cursor-GMWX7LCU.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-M4DESHU4.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-EAGXCZBC.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-QVGNVLI4.js")).disconnectSvg,
  discord: async () => (await import("./discord-SPRRBBQD.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-3EUAX4QK.js")).etherscanSvg,
  extension: async () => (await import("./extension-JB6XNZTV.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-ELO2EEAI.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-QDI772WV.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-5C6ASCRW.js")).farcasterSvg,
  filters: async () => (await import("./filters-EMJBTG7H.js")).filtersSvg,
  github: async () => (await import("./github-W2IAYQ7W.js")).githubSvg,
  google: async () => (await import("./google-XZYH727E.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-LTR3NBJA.js")).helpCircleSvg,
  image: async () => (await import("./image-GIPU6ANK.js")).imageSvg,
  id: async () => (await import("./id-WJZSLGZF.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-2FMAAGBI.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-DWMIXWKL.js")).lightbulbSvg,
  mail: async () => (await import("./mail-4EN4TLQ4.js")).mailSvg,
  mobile: async () => (await import("./mobile-H4RM6BMP.js")).mobileSvg,
  more: async () => (await import("./more-YTLXYIE5.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-X2JAJ2WV.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-CVYKIGNG.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-EWWTN5JB.js")).offSvg,
  playStore: async () => (await import("./play-store-U34YC5M4.js")).playStoreSvg,
  plus: async () => (await import("./plus-FUOSAB7M.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-JDKLXWLZ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-3HBL7MZH.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-QZAZ2GL4.js")).refreshSvg,
  search: async () => (await import("./search-762S3OWS.js")).searchSvg,
  send: async () => (await import("./send-UYGOHVMH.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-AP64E5OF.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-J4ZZMSMB.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-YHRW4DPJ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-2AONEJCR.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-FBF6QB4J.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-WCCEIBAH.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-O2XSESJV.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-JHD66TFX.js")).twitchSvg,
  twitter: async () => (await import("./x-BXRCLAC6.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-4TPHPHYF.js")).twitterIconSvg,
  verify: async () => (await import("./verify-FIS6DHYT.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-VPAGX7ES.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-EXPBKR54.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-3SVZJSEQ.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-3SVZJSEQ.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-3SVZJSEQ.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-LUVZXYIR.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-G3SPMKOH.js")).warningCircleSvg,
  x: async () => (await import("./x-BXRCLAC6.js")).xSvg,
  info: async () => (await import("./info-B2JSFD5H.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-FZVUNTZ4.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-HPOXMXNS.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KIE46DZI.js.map
