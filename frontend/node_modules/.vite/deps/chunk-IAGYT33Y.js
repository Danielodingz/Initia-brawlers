...
import {
  secp256k1
} from "./chunk-4SQHJG7F.js";
import {
  hmac,
  sha256,
  sha512
} from "./chunk-VSP4ONIR.js";
import {
  abytes,
  ahash,
  anumber,
...
var secp256k1_hasher = (() => createHasher(secp256k12.Point, (scalars) => {
...
var HDKey = class _HDKey {
  ...
  sign(hash) {
    ...
    abytes(hash, 32);
    return secp256k12.sign(hash, this.privKey).toCompactRawBytes();
  }
  verify(hash, signature) {
    ...
    return secp256k12.verify(sig, hash, this.publicKey);
  }
  wipePrivateData() {
    this.privKey = void 0;
...
*/
//# sourceMappingURL=chunk-IAGYT33Y.js.map
